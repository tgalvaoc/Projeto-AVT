...
void init()
{
	...
	//create geometry and VAO of cube
	//cria a malha 
	amesh = createCube();
	//cor que o cubo tem quando não está sendo iluminado
	//amesh.mat.ambient[0] = 0.1f;
	//amesh.mat.ambient[1] = 0.1f;
	//amesh.mat.ambient[2] = 0.1f;
	//amesh.mat.ambient[3] = 0.5f;
